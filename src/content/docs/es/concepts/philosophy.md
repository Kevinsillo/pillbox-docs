...
2. Durante la sesión, llama a `pill_take` cuando ocurra algo que valga la pena recordar — una decisión no obvia, un bug encontrado y resuelto, una limitación descubierta.

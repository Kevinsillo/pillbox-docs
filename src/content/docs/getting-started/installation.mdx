...
4. (Optional) Install SDD skill and agents:
   ...
   Installs the Spec-Driven Development skill and sub-agents to the global configuration folder of each detected provider (Claude Code, OpenCode). The script detects which providers are installed and lets you choose.
